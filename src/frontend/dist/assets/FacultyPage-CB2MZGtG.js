import { j as jsxRuntimeExports, r as reactExports, L as Link, u as useNavigate } from "./index-CWBSPPg1.js";
import { L as Layout } from "./Layout-BqPaQAtX.js";
import { a as cn } from "./utils-CwJNFt5C.js";
...
import { S as Search } from "./Header-D5iK_n6Q.js";
import { A as AnimatePresence } from "./index-CcF26wws.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Layout, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "section",
      {
        ...
        style: {
          background: "linear-gradient(135deg, #1F1B47 0%, #332C6F 55%, #4A3FA0 100%)",
          minHeight: "340px"
        },
        children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                motion.div,
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(Users, { className: "w-8 h-8", style: { color: "#F5A623" } })
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  motion.h1,
                  {
                    ...
                    children: [
                      "Our ",
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#F5A623" }, children: "Faculty" })
                    ]
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
              ...
              motion.div,
              {
                ...
                children: STATS.map((stat) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-[11px] text-white/50 leading-tight", children: stat.label })
                  ] })
                ] }, stat.label))
              }
            )
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container px-4 md:px-8 py-3 flex flex-col sm:flex-row items-start sm:items-center gap-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "p",
            {
              ...
              style: { color: "#6b7280" },
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#332C6F", fontWeight: 700 }, children: filtered.length }),
                " ",
                "of ",
                FACULTY_DATA.length,
                " faculty"
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(Users, { className: "w-9 h-9", style: { color: "#332C6F" } })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "h3",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.section,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container px-4 md:px-8 flex flex-col md:flex-row items-center justify-between gap-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-heading text-2xl md:text-3xl font-bold text-white mb-2", children: "Interested in our MBA Programme?" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-white/60 text-sm md:text-base", children: "Learn about admissions, curriculum, and placements at COEP DMS." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Link,
            {
...
function FacultyGridCard({ faculty, index }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      style: {
        boxShadow: hovered ? "0 20px 48px rgba(51,44,111,0.18), 0 4px 12px rgba(0,0,0,0.08)" : "0 4px 20px rgba(0,0,0,0.07)",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative overflow-hidden", style: { height: "260px" }, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: {
                background: "linear-gradient(to top, rgba(31,27,71,0.7) 0%, rgba(31,27,71,0.1) 50%, transparent 100%)"
              }
            }
          ),
