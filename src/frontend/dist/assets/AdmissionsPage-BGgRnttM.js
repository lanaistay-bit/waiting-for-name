        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "h4",
            {
              ...
              style: { color: DEEP_BLUE, fontFamily: "Playfair Display, serif" },
              children: "Important Dates (Indicative 2025–26)"
            }
          ),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(InfoCard, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "h3",
          {
            className: "text-2xl font-bold mb-6",
            style: { color: DEEP_BLUE, fontFamily: "Playfair Display, serif" },
            children: "M.Tech Specialisations"
          }
        ),
              ...
              children: [
                ...
                programHighlights.map((row, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    ...
                    style: {
                      borderBottom: i < programHighlights.length - 1 ? "1px solid rgba(22,72,200,0.1)" : "none"
                    },
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "span",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(InfoCard, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "h3",
          {
            className: "text-2xl font-bold mb-5",
            style: { color: DEEP_BLUE, fontFamily: "Playfair Display, serif" },
            children: "Why PG Diploma at COEP?"
          }
        ),
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  ...
                  children: "For queries, contact the office between 9:30 AM – 5:30 PM on working days."
                }
              ),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative max-w-[1280px] mx-auto px-4 xl:px-8 pt-14 pb-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                    ...
                    style: { fontFamily: "Source Sans 3, sans-serif" },
                    children: "Your journey to academic excellence begins here. Over 170 years of engineering tradition, NAAC A++ accreditation, and world-class research opportunities await you."
                  }
                ),
