import { a as useParams, u as useNavigate, j as jsxRuntimeExports, r as reactExports } from "./index-ewouZ8Z-.js";
...
import { c as createLucideIcon } from "./utils-pycC2CyQ.js";
...
import { B as Building2, T as Trophy } from "./trophy-BeBqcmGX.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "typo-stat-label mt-2 text-white/75", children: label })
      ]
    }
  );
}
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "typo-stat-label text-white/70", children: stat.label })
      ]
    }
  );
}
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-10", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "p",
          {
            ...
            style: { color: "#555" },
            children: "A legacy of excellence — COEP graduates power the world's top organisations"
          }
        )
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "section",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "typo-body text-center mb-10", style: { color: "#666" }, children: "A structured, transparent journey from registration to offer letter" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4", children: [
            ...
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "typo-stat-label", style: { color: "#777" }, children: step.d })
              ]
            },
            step.n
          )) })
...
function RecruitersSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-14", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "typo-body-lg max-w-2xl mx-auto", style: { color: "#555" }, children: "Over 245 companies across sectors trust COEP talent — from global tech giants to industrial leaders and fast-growing startups." })
    ] }),
...
function StatisticsSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-14", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "typo-body-lg max-w-2xl mx-auto", style: { color: "#555" }, children: "Transparent, year-on-year data reflecting consistent growth in our placement outcomes" })
    ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4", children: [
      ...
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "typo-stat-number mb-1", style: { color: COBALT }, children: item.value }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
...
function CareerServicesSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-14", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "typo-body-lg max-w-2xl mx-auto", style: { color: "#555" }, children: "Comprehensive, year-round support ensuring every COEP student is placement-ready" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-3 gap-6", children: SERVICES.map((s, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "typo-card-title mb-3", style: { color: DEEP_BLUE }, children: s.title }),
...
function TrainingSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-14", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "typo-body-lg max-w-2xl mx-auto", style: { color: "#555" }, children: "A structured 3-month pre-placement training programme designed to build interview-ready graduates" })
    ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "typo-body text-sm text-white/70", children: m.desc })
              ]
            }
          ),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-4 gap-5", children: UPCOMING_WORKSHOPS.map((w, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "typo-support space-y-1", style: { color: "#777" }, children: [
...
function AlumniSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-14", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "typo-body-lg max-w-2xl mx-auto", style: { color: "#555" }, children: "COEP graduates shaping the future at the world's most admired organisations" })
    ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-2 gap-6", children: visibleAlumni.map((a, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-8 text-white", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "typo-body-lg text-base text-white/85 mb-7 italic", children: [
              '"',
              a.quote,
              '"'
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "typo-card-title font-bold text-lg text-white", children: a.name }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "typo-body text-sm text-white/70", children: [
                      a.role,
                      " — ",
                      a.company
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "typo-stat-label text-white/50 mt-0.5", children: [
                      a.dept,
                      " Department, Batch of ",
                      a.batch
                    ] })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "typo-body text-white/75 max-w-xl mx-auto", children: "Over 168 years of engineering excellence. Join thousands of COEP alumni making a mark at the world's most respected companies." }),
