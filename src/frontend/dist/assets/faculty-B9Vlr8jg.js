const FACULTY_DATA = [
  // ── HIERARCHY POSITION 1 ──────────────────────────────────────────────────
  {
    ...
    title: "Associate Professor (Geology) & Dean — School of Transdisciplinary Sciences and Management",
    designation: "Associate Dean, School of Multidisciplinary Sciences & Management | Associate Professor (Geology), COEP Technological University",
    expertise: [
      "Engineering Geology",
      "Dam Safety",
      "Corporate Relations",
    ...
    qualification: "Ph.D. in Geology (Faculty of Science), Amravati University | M.Sc (Tech) Applied Geology, Nagpur University",
  ...
  // ── HIERARCHY POSITION 2 ──────────────────────────────────────────────────
  {
    ...
    designation: "Professor of Practice & Academic Head, Department of Management Studies, COEP Technological University",
    expertise: [
    ...
    qualification: "PhD in Management, MPM (MBA-HR), LLB, B.Com — Savitribai Phule Pune University (SPPU)",
  ...
  // ── HIERARCHY POSITION 3 ──────────────────────────────────────────────────
  {
    ...
    designation: "Associate Professor & Deputy Training and Placement Officer, COEP Technological University (UG & PG)",
    expertise: [
      "Strategic Alliances",
    ...
    qualification: "Management Professional — 20+ years cross-industry experience",
  ...
  // ── HIERARCHY POSITION 4 ──────────────────────────────────────────────────
  {
    ...
    designation: "Assistant Professor, Department of Management Studies, COEP Technological University",
    expertise: [
    ...
    qualification: "MBA – Finance (First Class), BE – Chemical Engineering (First Class)",
  ...
  },
  {
    ...
    qualification: "MBA – HR (University of Pune), Counsellor Certification (PGCCP), B.Com",
