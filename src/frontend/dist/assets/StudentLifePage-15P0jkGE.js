import { a as useParams, u as useNavigate, r as reactExports, j as jsxRuntimeExports } from "./index-CWBSPPg1.js";
...
import { D as Dumbbell, W as Wifi } from "./wifi-DiI0TSle.js";
...
import { S as Shield } from "./shield-WNAqaLgq.js";
...
function OverviewSection() {
  ...
  const timelineItems = [
    ...
    {
      year: "1869",
      event: "Historic Boat Club founded — a symbol of COEP's sporting heritage."
    },
    {
      year: "1920s",
      event: "First student clubs formed — drama, music, and literary societies."
    },
    {
      year: "1980s",
      event: "IMPRESSIONS cultural festival launched, becoming Pune's largest cultural fest."
    },
    {
      year: "2000s",
      event: "E-Cell and technical fests added, reflecting COEP's innovation ecosystem."
    },
    {
      year: "2022",
      event: "COEP elevated to Technological University status — student life expands dramatically."
    }
  ];
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "h3",
            {
              ...
              style: { color: DEEP_BLUE, fontFamily: "Playfair Display, serif" },
              children: "Student Life Through the Ages"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-6", children: timelineItems.map((item, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", style: { background: fest.color }, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 grid md:grid-cols-5 gap-0", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-3 p-10", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-4", children: fest.highlights.map((hl) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "li",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white/85 text-[15px] leading-relaxed", children: hl })
                  ]
                },
                hl
              )) })
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "h4",
                    {
                      ...
                      style: { fontFamily: "Playfair Display, serif" },
                      children: "Physical Education Department"
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "p",
                    {
                      ...
                      style: { fontFamily: "Source Sans 3, sans-serif" },
                      children: "For sports scholarships, trial registrations, and facility bookings, contact our Physical Education Department."
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "a",
  ...
  function HostelCard({
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        style: {
          borderColor: hostel.gender === "Boys" ? `${COBALT}22` : "rgba(22,72,200,0.22)"
        },
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
                ...
                style: {
                  backgroundColor: hostel.gender === "Boys" ? `${COBALT}15` : "rgba(22,72,200,0.1)",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  className: "text-white/60 text-xs",
                  style: { fontFamily: "Source Sans 3, sans-serif" },
                  children: "Annual Hostel Fee (approx.)"
                }
              )
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  className: "text-white/60 text-xs",
                  style: { fontFamily: "Source Sans 3, sans-serif" },
                  children: "Mess Fee (annual approx.)"
                }
              )
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "h4",
              {
                ...
                style: { color: DEEP_BLUE, fontFamily: "Playfair Display, serif" },
                children: "Hostel Allotment Enquiries"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                className: "text-sm",
                style: { color: "#556", fontFamily: "Source Sans 3, sans-serif" },
                children: "Contact the Hostel Office or apply through the student portal during admission season."
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
              ...
              children: "Contact Hostel Office →"
            }
          )
        ]
      }
