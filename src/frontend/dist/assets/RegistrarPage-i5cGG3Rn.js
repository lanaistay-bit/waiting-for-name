import { j as jsxRuntimeExports, L as Link, r as reactExports } from "./index-pJv4La_B.js";
import { L as Layout } from "./Layout-BxZ-EAyt.js";
import { R as REGISTRAR } from "./administration-BzYAFRya.js";
import { A as ArrowLeft } from "./arrow-left-CuwW-CQZ.js";
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-6 pb-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "nav",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "›" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Registrar" })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-16 lg:gap-24 items-center pb-16", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "order-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                    ...
                    style: { color: "#4b5563" },
                    children: reg.designation
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "typo-body mb-8", style: { color: "#374151" }, children: reg.brief }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "order-2 flex justify-end", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { height: "3px", background: DEEP_BLUE } })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-6xl mx-auto px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatedSection, { delay: 0.1, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "typo-body", style: { color: "#374151" }, children: reg.brief }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "typo-body mt-4", style: { color: "#4b5563" }, children: "The Registrar's Office is responsible for maintaining the official academic records of all students, managing examinations, overseeing regulatory compliance, and serving as the Secretary to the Academic Council and the Board of Management. As a key liaison between the administration and the university community, the Registrar ensures smooth academic operations across all departments." })
            ]
          }
        ) }) })
      }
      ...
      "section",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(AnimatedSection, { delay: 0.05, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "typo-section-label mb-3", style: { color: DEEP_BLUE }, children: "Profile" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "h2",
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-3 gap-8", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
              reg.research.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatedSection, { delay: 0.1, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ContentCard, { icon: Award, title: "Research Areas", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: reg.research.map((area) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
              ...
              reg.education.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatedSection, { delay: 0.2, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ContentCard, { icon: GraduationCap, title: "Education", children: /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-3", children: reg.education.map((edu) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-2 space-y-6", children: [
              reg.experience.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatedSection, { delay: 0.1, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ContentCard, { icon: Briefcase, title: "Professional Experience", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  className: "relative pl-6 border-l-2",
                  style: { borderColor: "rgba(26,35,126,0.15)" },
                  children: reg.experience.map((exp) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
              ...
              reg.achievements.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatedSection, { delay: 0.2, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ContentCard, { icon: Award, title: "Key Achievements", accent: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: reg.achievements.map((achievement) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
      ...
      "section",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "typo-body text-sm text-white/70 mt-1", children: "Learn about COEP Tech's leadership team and governance structure" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Link,
            {
