import { r as reactExports, j as jsxRuntimeExports, L as Link } from "./index-CUgpWnl1.js";
import { S as SubTabRibbon } from "./SubTabRibbon-BKmFbHDc.js";
import { C as CHANCELLOR, a as CHAIRMAN, V as VICE_CHANCELLOR, R as REGISTRAR, D as DIRECTORS, b as DEANS, A as ASSOCIATE_DEANS } from "./administration-DsOHO0fz.js";
import { M as Mail, P as Phone, X } from "./x-BlGPumW2.js";
...
function AdministrationPage() {
  ...
  const [activeTab, setActiveTab] = reactExports.useState("chancellor");
  const chancellorRef = useScrollReveal(0.05);
  const chairmanRef = useScrollReveal(0.05);
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-6xl mx-auto px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            style: {
              ...
              transform: chancellorRef.visible ? "translateY(0)" : "translateY(40px)",
              transition: "opacity 0.7s ease, transform 0.7s ease"
            },
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "typo-section-label mb-4", style: { color: COBALT }, children: "Chancellor" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "h2",
                  {
                    className: "typo-hero-heading mb-3 leading-tight",
                    style: { color: DEEP_BLUE },
                    children: CHANCELLOR.name
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                    ...
                    style: { color: "#4b5563" },
                    children: CHANCELLOR.designation
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "typo-body mb-8", style: { color: "#374151" }, children: CHANCELLOR.brief }),
                          ...
                          "img",
                          {
                            ...
                            onError: (e) => {
                              ...
                              if (parent && !parent.querySelector(".img-fallback")) {
                                ...
                                fb.style.background = "linear-gradient(135deg, #1A237E 0%, #081E5C 100%)";
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-6xl mx-auto px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            style: {
              ...
              transform: chairmanRef.visible ? "translateY(0)" : "translateY(40px)",
              transition: "opacity 0.7s ease, transform 0.7s ease"
            },
            children: [
                          ...
                          "img",
                          {
                            ...
                            onError: (e) => {
                              ...
                              if (parent && !parent.querySelector(".img-fallback")) {
                                const fb = document.createElement("div");
                                fb.className = "img-fallback w-full h-full";
                                fb.style.background = "linear-gradient(135deg, #0F3399 0%, #081E5C 100%)";
                                parent.appendChild(fb);
                              }
                            }
                          }
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "order-1 md:order-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "typo-body mb-8", style: { color: "#374151" }, children: CHAIRMAN.brief }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-2 mb-8", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "a",
                    {
