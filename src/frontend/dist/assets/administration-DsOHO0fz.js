const CHANCELLOR = {
  ...
  photoUrl: "/assets/generated/chancellor-devvrat-portrait.dim_400x500.jpg",
  ...
  experience: [
    ...
    "Discharging functions of Governor of Maharashtra since 15 September 2025",
    "Former Governor of Himachal Pradesh (12 August 2015 – 21 July 2019)",
    "45 years of experience in teaching and administration",
  ...
  research: [],
  achievements: [
    "Led over 500,000 farmers in Gujarat to shift from chemical to natural farming",
...
const CHAIRMAN = {
  ...
  phone: "+91 20 2550 7000",
  photoUrl: "/assets/generated/chairman-vinayak-pai-portrait.dim_400x500.jpg",
  ...
  experience: [
    ...
    "Chairman, Board of Governance, COEP Technological University",
    "Chairman, National Committee of Roads & Highways, CII",
    "Vice-Chairman, Confederation of Indian Industry (CII) Maharashtra",
  ...
  research: [],
  achievements: [
    "Led delivery of marquee national projects: New Parliament Building, Mumbai Trans Harbour Link, Noida International Airport",
...
const DIRECTORS = [
  {
    ...
    board: "Research, Innovation, Incubation and Linkages (RIIL)",
  ...
  {
    slug: "yv-haribhakta",
    name: "Dr. (Mrs.) Y. V. Haribhakta",
    designation: "Associate Professor & Director",
    department: "Computer Science and Engineering",
    board: "Examinations and Evaluation",
  ...
  {
    slug: "ag-thosar",
    name: "Dr. (Mrs.) A. G. Thosar",
    designation: "Professor & Director",
    board: "Knowledge Resource Centre (KRC)",
...
const ASSOCIATE_DEANS = [
  {
    ...
    designation: "Associate Professor & Associate Dean",
