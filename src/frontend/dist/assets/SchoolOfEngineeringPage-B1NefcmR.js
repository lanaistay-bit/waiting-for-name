import { j as jsxRuntimeExports, L as Link } from "./index-pJv4La_B.js";
import { L as Layout } from "./Layout-BxZ-EAyt.js";
import { q as motion } from "./proxy-DbSqHpMk.js";
    ...
    motion.div,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-5 flex flex-col flex-1", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "typo-card-desc flex-1 mb-4", style: { color: "#6b7280" }, children: dept.description }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 typo-support transition-all duration-200 group-hover:gap-2.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: dept.color }, children: "View Details" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              ChevronRight,
              {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: "absolute inset-0",
              style: {
                background: "linear-gradient(135deg, rgba(8,30,92,0.88) 0%, rgba(26,35,126,0.70) 60%, rgba(8,30,92,0.85) 100%)"
              }
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              motion.div,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "typo-section-label text-white/75", children: "COEP Technological University" })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              ...
              motion.div,
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-7 flex flex-col flex-1", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-end gap-3 mb-2", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "typo-section-heading text-white", children: prog.title }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                      {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "typo-body text-white/75 mb-5 flex-1", children: prog.description }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "typo-section-heading text-white", children: "Join the School of Engineering" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "typo-body text-white/70 mt-1", children: "170+ years of engineering excellence in Pune." })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
