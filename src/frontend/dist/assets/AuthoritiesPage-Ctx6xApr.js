import { r as reactExports, u as useNavigate, j as jsxRuntimeExports } from "./index-CWBSPPg1.js";
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-7 pb-5 flex flex-col gap-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-gray-600 leading-relaxed text-sm", children: committee.description })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
...
function CommitteeTable({ committees }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full overflow-x-auto rounded-2xl shadow-premium", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "min-w-full text-sm", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "bg-cobalt text-white", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-5 py-4 text-left font-bold font-body w-16 rounded-tl-2xl", children: "Sr. No." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-5 py-4 text-left font-bold font-body w-64", children: "Committee Name" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-5 py-4 text-left font-bold font-body rounded-tr-2xl", children: "Description" })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: committees.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "tr",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-5 py-4 text-center font-bold text-cobalt font-body", children: c.srNo }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "px-5 py-4 font-bold font-heading text-deep-blue text-sm leading-snug", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mr-2", children: c.icon }),
            c.name
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-5 py-4 text-gray-600 font-body leading-relaxed", children: c.description })
        ]
      },
      c.name
    )) })
...
function AuthoritiesPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-white font-body", children: [
          ...
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 mb-6", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-cobalt font-bold text-sm uppercase tracking-widest font-body", children: "Governance Structure" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-700 font-body leading-relaxed text-lg mb-5", children: AUTHORITIES_DATA.intro }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-cobalt-subtle border-l-4 border-cobalt rounded-lg px-6 py-4 text-gray-700 font-body text-base", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold text-cobalt", children: "Legal Basis: " }),
                "As per the",
                " ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-deep-blue", children: "COEP Technological University Act" }),
            ...
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-3 mb-4", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "divider-cobalt", "aria-hidden": "true" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-cobalt font-bold text-sm uppercase tracking-widest font-body", children: "As per COEP Tech Act" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "divider-cobalt", "aria-hidden": "true" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "h2",
                  {
                    ...
                    children: "University Authorities, Boards and Committees"
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-gray-600 max-w-2xl mx-auto text-base", children: "Eleven statutory bodies govern every domain of university life — from academics and finance to student welfare and research excellence." })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-end mb-8 gap-2", ref: tableSection.ref, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                className: `px-4 py-2 rounded-lg text-sm font-semibold font-body transition-smooth border ${viewMode === "grid" ? "bg-cobalt text-white border-cobalt shadow-cobalt" : "bg-white text-cobalt border-cobalt hover:bg-cobalt-subtle"}`,
                children: "⊞ Grid View"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                className: `px-4 py-2 rounded-lg text-sm font-semibold font-body transition-smooth border ${viewMode === "table" ? "bg-cobalt text-white border-cobalt shadow-cobalt" : "bg-white text-cobalt border-cobalt hover:bg-cobalt-subtle"}`,
                children: "☰ Table View"
              }
            )
          ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-white/80 text-base mb-3 max-w-2xl mx-auto leading-relaxed", children: "For official queries regarding governance and committees, contact the Registrar's Office at COEP Technological University." }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-white/70 text-sm mb-6", children: "📍 Wellesley Rd, Shivajinagar, Pune – 411 005, Maharashtra, India" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "a",
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-white/50 text-xs mt-4", children: "info@coeptech.ac.in" })
              ]
            }
          )
        ]
