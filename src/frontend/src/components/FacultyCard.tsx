  ...
  return (
    ...
    >
      ...
      <div className="relative overflow-hidden" style={{ height: "240px" }}>
        ...
        {faculty.isSpecial && (
          <div
            className="absolute top-3 left-3 px-2.5 py-1 rounded-full text-[10px] font-inter font-bold uppercase tracking-wider"
        ...
        <AnimatePresence>
          {faculty.email && hovered && (
            <motion.a
              ...
              className="absolute bottom-3 right-3 flex items-center gap-1.5 px-3 py-1.5 rounded-full text-[11px] font-inter font-semibold"
      ...
      <div className="p-5 flex flex-col gap-3 flex-1">
        <div>
          <h3
            className="typo-card-title line-clamp-2"
            style={{ color: "#0F3399" }}
          >
            {faculty.name}
          </h3>
          ...
          {faculty.qualification && (
            <p
              className="font-inter text-xs mt-0.5 line-clamp-1"
              style={{ color: "#6b7280" }}
            >
              {faculty.qualification}
            </p>
        ...
        <div className="flex flex-wrap gap-1.5">
          {faculty.expertise.slice(0, 3).map((tag) => (
            <Badge
              key={tag}
              variant="secondary"
              className="typo-support text-[10px] px-2 py-0 font-normal border-0"
              style={{
        ...
        <Link
          ...
          className="typo-btn flex items-center justify-between px-4 py-2.5 rounded-xl text-sm mt-1 transition-all duration-300"
          style={{
