...
const CAMPUS_COUNTER_STATS = [
  { target: 4500, suffix: "+", label: "Students" },
  { target: 500, suffix: "+", label: "Faculty & Staff" },
  { target: 50, suffix: "+", label: "Buildings" },
  { target: 170, suffix: "+", label: "Years Heritage" },
];
        ...
        <div className="fade-in-left">
            ...
            {CAMPUS_HIGHLIGHTS.map((item) => (
              <li key={item.text} className="flex items-start gap-3">
                <div
                  ...
                  style={{ backgroundColor: "rgba(22,72,200,0.09)" }}
                >
          ...
          <div className="mt-8">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center gap-2 px-6 py-3 rounded-lg font-semibold transition-smooth hover:shadow-cobalt hover:-translate-y-0.5"
              style={{
...
const LIBRARY_TIMINGS = [
  { day: "Mon – Fri", time: "8:00 AM – 10:00 PM" },
  { day: "Saturday", time: "9:00 AM – 5:00 PM" },
  { day: "Sunday", time: "10:00 AM – 4:00 PM" },
  { day: "Exam Season", time: "8:00 AM – 11:00 PM" },
];
  ...
  return (
    <div>
      ...
      <div className="grid md:grid-cols-5 gap-8 mb-12">
        {/* Main description */}
        <div className="md:col-span-3 fade-in-left">
          <h3
          ...
          >
            ...
            Springer, and ASME ensure students have access to the latest global
          ...
          <div className="flex flex-wrap gap-2">
            {KRC_DATABASES.map((db) => (
              <span
                ...
                style={{
                  backgroundColor: "rgba(22,72,200,0.08)",
                  color: COBALT,
                  fontFamily: "Source Sans 3, sans-serif",
                }}
              >
        ...
        {/* Sidebar */}
        <div className="md:col-span-2 space-y-4 fade-in-right">
          <div
            className="rounded-xl p-6"
            style={{
              background: `linear-gradient(135deg, ${COBALT}, ${MIDNIGHT})`,
            }}
            data-ocid="facilities.library.timings_card"
          >
          ...
          <div
            ...
            data-ocid="facilities.library.contact_card"
          >
            <h4
            ...
            <div className="space-y-3">
              {[
                { Icon: Users, text: "Dr. S. R. Patil, Chief Librarian" },
                { Icon: Phone, text: "+91-20-2550 7100" },
                { Icon: Mail, text: "library@coeptech.ac.in" },
                {
                  Icon: MapPin,
                  text: "Ground Floor, Main Building, COEP Campus",
                },
              ].map(({ Icon, text }) => (
        ...
        {SPORTS_FACILITIES.map((sport, i) => (
          ...
          >
            <div
              ...
              style={{ backgroundColor: "rgba(22,72,200,0.08)" }}
            >
...
const GIRLS_HOSTELS = [
  { name: "Jijaoo", capacity: "~300 students" },
  { name: "Lohagad", capacity: "~200 students" },
];

const HOSTEL_AMENITIES = [
  { icon: Cpu, label: "High-Speed Wi-Fi" },
  { icon: Shield, label: "24/7 Security" },
  { icon: Layers, label: "Mess / Cafeteria" },
  { icon: Wrench, label: "Laundry Service" },
  { icon: Dumbbell, label: "Indoor Gym" },
  { icon: Phone, label: "Medical Support" },
];
...
function HostelsTab() {
  return (
    <div>
      ...
      {/* Capacity banner */}
      <div
        className="rounded-2xl p-6 md:p-8 mb-10 text-center"
        style={{
      ...
      <div className="grid md:grid-cols-2 gap-10 mb-10">
        ...
        <div className="fade-in-left">
          ...
          <div className="grid grid-cols-2 gap-3">
            {BOYS_HOSTELS.map((h, i) => (
              <div
                key={h.name}
                className="rounded-xl p-4 transition-smooth hover:shadow-premium fade-in-up"
                style={{
                  border: "1px solid rgba(22,72,200,0.14)",
                  background: "#fff",
                  animationDelay: `${i * 60}ms`,
        ...
        <div className="fade-in-right">
          ...
          >
            <span
              className="w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold text-white"
              style={{ backgroundColor: COBALT, color: "white" }}
            >
              G
            </span>
            Girls' Hostels
          ...
          <div className="grid grid-cols-2 gap-3 mb-6">
            {GIRLS_HOSTELS.map((h, i) => (
              <div
                key={h.name}
                className="rounded-xl p-4 transition-smooth hover:shadow-premium fade-in-up"
                style={{
                  border: "1px solid rgba(232,196,42,0.3)",
                  background: "rgba(232,196,42,0.05)",
                  animationDelay: `${i * 60}ms`,
                }}
                data-ocid={`facilities.hostels.girls.${i + 1}`}
              >
                <div
                  className="font-bold text-sm mb-1"
                  style={{
          ...
          <div
            ...
            style={{ border: "1px solid rgba(22,72,200,0.14)" }}
      ...
      >
        {HOSTEL_AMENITIES.map((a, i) => (
          <div
            key={a.label}
            className="rounded-xl p-4 text-center transition-smooth hover:shadow-premium fade-in-up"
            style={{
              border: "1px solid rgba(22,72,200,0.14)",
              background: "#fff",
              animationDelay: `${i * 60}ms`,
        ...
        {VENUES.map((venue, i) => (
          ...
          >
            ...
            <div className="p-6 bg-white">
              ...
              <button
                type="button"
                className="w-full py-2.5 rounded-lg font-semibold text-sm transition-smooth hover:shadow-cobalt hover:-translate-y-0.5"
                style={{
          ...
          <div className="grid grid-cols-3 gap-3 text-center">
            {[
              ...
              <div
                ...
                style={{
                  backgroundColor: "rgba(22,72,200,0.06)",
